"""Synthetic LP / investor CRM — 60 VC LP contacts."""
...
FIRMS_BY_TYPE = {
    ...
    "fof": ["HarbourVest Partners", "Adams Street Partners", "Pathway Capital Management",
            ...
            "Aberdeen Standard Venture Capital"],
...
FOCI = ["venture", "seed", "early_stage", "multi_stage", "growth"]
...
def generate(count: int = 60, seed: int = 42) -> list[dict]:
    ...
    for i in range(count):
        ...
        notes_pool = [
            f"Focuses on {focus.replace('_', ' ')} in {geo}. Prefers emerging and established venture managers.",
            f"Introduced by {rng.choice(['placement agent', 'warm intro', 'Selects', 'co-invest LP'])}. Looking for differentiated venture exposure.",
