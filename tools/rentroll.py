...
fastvc.cap_tables (equity ownership snapshots).
"""
...
def _load_cap_table(slug_or_id: str):
    try:
        ...
        row = fetch_one(
            ...
            "JOIN fastvc.cap_tables ct ON ct.company_id = c.id "
...
walt_years = waterfall  # repurposed — no rent-roll weighted term in VC; returns waterfall
