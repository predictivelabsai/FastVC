"""Generate a FastVC product tour PDF from the demo screenshots.

Output: docs/fastvc-product-tour.pdf
...
OUT = ROOT / "docs" / "fastvc-product-tour.pdf"
...
def _footer(canvas, doc):
    ...
    canvas.drawString(1.5 * cm, 0.55 * cm, "FastVC · Your Venture Capital AI Agent Squad")
...
def _hero_slide(styles):
    return [
        ...
        Paragraph("Your Venture Capital AI Agent Squad.", styles["hero_sub"]),
...
def _agenda_slide(styles):
    rows = [
        ["01", "Chat — your Venture Capital AI Agent Squad on call",
...
def _closing_slide(styles):
    ...
    return [
        ...
        Paragraph("See FastVC on your deals.", ParagraphStyle(
        ...
        Paragraph(
            ...
            "FastVC and show you the full agent flow — live.",
            cta_body,
        ),
        Spacer(1, 10 * mm),
        Paragraph(
            "<b>hello@fastvc.fyi</b> &nbsp;·&nbsp; fastvc.fyi/contact",
            cta_meta,
        ),
        Spacer(1, 2 * mm),
        Paragraph(
...
def build() -> None:
    ...
    story += _slide(
        styles,
        eyebrow="01 · Chat",
        title="One chat, every VC specialist",
        subtitle="Type a prefix or plain English — FastVC picks the right agent.",
        bullets=[
    ...
    story += _slide(
        ...
        subtitle="VC-relevant headlines from FT, Bloomberg, WSJ, Reuters, BBC — right where you work.",
        bullets=[
    ...
    story += _slide(
        ...
        bullets=[
            "Each role has its own set of instructions, plus a shared VC glossary.",
    ...
    story += _slide(
        ...
        bullets=[
            ...
            "Shared VC context is applied automatically so you don't repeat yourself.",
